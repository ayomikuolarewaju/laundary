...
export default function Header() {
  return (
    <header className=" sticky top-0 z-50 justify-center items-center max-w-9xl mx-auto w-[700px] mb-[30px]">
      <div className="px-6 py-4 max-w-7xl">
        <div className="flex ">
          <div className="flex md:flex-col items-center space-y-[50px] mt-5 md:space-y-0 justify-center w-[700px] mx-auto">
